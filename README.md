...
To do list app for Brainstation Immersive program.
...
git clone https://github.com/JosueCuberoSanchez/to_do_list.git
...
* [Gulp](https://gulpjs.com/) - Build, server simulation and deploy tool used.
